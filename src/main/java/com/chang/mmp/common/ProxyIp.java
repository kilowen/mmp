...
public class ProxyIp {
	...
	public static void setProxy() {
		...
		ProxyPo p26 = new ProxyPo("26", "182.92.77.169", "3128","浙江省杭州市 阿里巴巴网络有限公司");
		...
		List<ProxyPo> list = new ArrayList<ProxyPo>();
		...
		System.getProperties().setProperty("http.proxyPort",
				list.get(i).getPort());
		System.out.println("设置代理服务器IP::" + list.get(i).getIp() + "端口：："
				+ list.get(i).getPort());
