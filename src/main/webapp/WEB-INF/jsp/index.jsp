...
<meta name="description" content="mmp">
...
<body>
	...
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.jsp">Freedom World</a>
		</div>
	...
	<div class="carousel-inner">
		<c:forEach items="${imgList}" var="img">
	...
	</c:forEach> <!--  <div class="item active">
                <div class="fill" style="background-image:url(http://p0.so.qhimg.com/t0116297b4131338095.jpg);"></div>
                <div class="fill" style="background-image:url('asset/images/slider-img-01.jpg');"></div>
                <div class="carousel-caption">
                    <h3>Caption 1</h3>
                    <p>Donec scelerisque aliquet mi, non venenatis urnas iaculis. </p>
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('asset/images/slider-img-02.jpg');"></div>
                <div class="carousel-caption">
                    <h3>Caption 2</h3>
                    <p>Donec scelerisque aliquet mi, non venenatis urnas iaculis. </p>
                </div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('asset/images/slider-img-03.jpg');"></div>
                <div class="carousel-caption">
                    <h3>Caption 3</h3>
                    <p>Donec scelerisque aliquet mi, non venenatis urnas iaculis. </p>
                </div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Welcome to Freedom World</h1>
			</div>
			<div class="col-md-4">
		...
		<div class="row">
			<div class="col-lg-12">
				<p align="center">Copyright &copy; Chang 2015</p>
			</div>
		</div>
		</footer>
